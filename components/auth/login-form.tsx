        ...
        <div className="grid grid-cols-2 gap-3">
          {DEMO_ACCOUNTS.map((account) => (
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-lg border-2 border-ef-primary/20 bg-ef-primary/5 px-4 py-3 text-sm font-semibold text-[#6C5CE7] transition-all hover:bg-ef-primary/10 hover:border-ef-primary/40 disabled:opacity-50 disabled:cursor-not-allowed"
            >
