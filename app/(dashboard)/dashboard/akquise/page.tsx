...
const DEMO_LEADS: Lead[] = [
  { id: "l1", companyName: "BSZ Sanitär & Heizung AG", industry: "Haustechnik", city: "Zürich", canton: "ZH", website: "https://bsz-sanitaer.ch", googleRating: 4.3, googleReviews: 42, score: 78, websiteScore: 55, socialScore: 20, seoScore: 48, status: "RECHERCHIERT", socialMedia: { instagram: false, facebook: true, linkedin: false, tiktok: false }, foundAt: "2026-05-22" },
  { id: "l2", companyName: "Pema Lüftung GmbH", industry: "Lüftungstechnik", city: "Winterthur", canton: "ZH", website: "https://pema-lueftung.ch", googleRating: 4.5, googleReviews: 18, score: 85, websiteScore: 42, socialScore: 10, seoScore: 35, status: "NEU", socialMedia: { instagram: false, facebook: false, linkedin: true, tiktok: false }, foundAt: "2026-05-22" },
  { id: "l3", companyName: "Sui Innova GmbH", industry: "Gebäudetechnik", city: "Bern", canton: "BE", website: "https://sui-innova.ch", googleRating: 4.1, googleReviews: 8, score: 72, websiteScore: 60, socialScore: 15, seoScore: 52, status: "NEU", socialMedia: { instagram: false, facebook: false, linkedin: true, tiktok: false }, foundAt: "2026-05-22" },
  { id: "l4", companyName: "Sada AG", industry: "Haustechnik", city: "Luzern", canton: "LU", website: "https://sada.ch", googleRating: 4.6, googleReviews: 67, score: 65, websiteScore: 70, socialScore: 25, seoScore: 62, status: "RECHERCHIERT", socialMedia: { instagram: false, facebook: true, linkedin: true, tiktok: false }, foundAt: "2026-05-21" },
  { id: "l5", companyName: "Neukom Marzolo AG", industry: "Sanitär & Heizung", city: "St. Gallen", canton: "SG", website: "https://neukom-marzolo.ch", googleRating: 4.4, googleReviews: 35, score: 81, websiteScore: 48, socialScore: 12, seoScore: 40, status: "NEU", socialMedia: { instagram: false, facebook: true, linkedin: false, tiktok: false }, foundAt: "2026-05-21" },
  { id: "l6", companyName: "SHS Haustechnik AG", industry: "Haustechnik", city: "Basel", canton: "BS", website: "https://shs-haustechnik.ch", googleRating: 4.2, googleReviews: 29, score: 74, websiteScore: 58, socialScore: 18, seoScore: 50, status: "ANGESCHRIEBEN", socialMedia: { instagram: false, facebook: true, linkedin: true, tiktok: false }, foundAt: "2026-05-20" },
  { id: "l7", companyName: "Ritschard Gebäudetechnik AG", industry: "Gebäudetechnik", city: "Thun", canton: "BE", website: "https://ritschard-gebaeudetechnik.ch", googleRating: 4.7, googleReviews: 53, score: 69, websiteScore: 65, socialScore: 22, seoScore: 58, status: "RECHERCHIERT", socialMedia: { instagram: false, facebook: true, linkedin: true, tiktok: false }, foundAt: "2026-05-20" },
