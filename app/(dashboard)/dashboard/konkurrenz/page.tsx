    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-semibold text-gray-900">Konkurrenz-Analyse</h1>
          </div>
          <p className="text-[13px] text-gray-500 mt-0.5">Vergleiche deine Performance mit Wettbewerbern.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-5">
          <h3 className="text-[14px] font-semibold text-gray-900 mb-1">Follower-Vergleich</h3>
        ...
        {selected && (
          <div className="rounded-2xl border border-gray-100 bg-white p-5">
            <h3 className="text-[14px] font-semibold text-gray-900 mb-1">Du vs. {selected.name}</h3>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <div className="text-right">
                <p className="text-[18px] font-bold text-gray-900">{(selected.totalFollower / 1000).toFixed(1)}k</p>
              ...
              return (
                <div key={p.platform} className="rounded-xl border border-gray-100 p-3.5">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[13px] font-medium text-gray-800">{p.platform}</span>
