...
export default function NeuerKundePage() {
  ...
  const inputBase =
    "w-full rounded-xl border border-gray-200 dark:border-white/10 bg-[#F8FAFC] dark:bg-white/[0.05] px-4 py-3 text-[13px] text-[#0F172A] dark:text-white transition-all focus:outline-none focus:ring-2 focus:ring-[#00CEC9]/20 focus:border-[#00CEC9] placeholder:text-gray-300 dark:placeholder:text-white/20"
    ...
    <div className="min-h-screen p-6 md:p-10 max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <Link
              ...
              className="flex items-center justify-center w-10 h-10 rounded-xl border border-gray-200 dark:border-white/10 hover:bg-gray-50 dark:hover:bg-white/[0.05] transition-colors"
            >
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/dashboard/kunden"
              className="border border-gray-200 dark:border-white/10 rounded-xl px-6 py-3 text-[13px] font-medium text-gray-500 dark:text-white/50 hover:bg-gray-50 dark:hover:bg-white/[0.05] transition-colors"
            >
              Abbrechen
            </Link>
            <button
              type="submit"
              className="bg-gradient-to-r from-[#00CEC9] to-[#6C5CE7] text-white rounded-xl px-6 py-3 text-[13px] font-semibold shadow-md shadow-[#00CEC9]/20 flex items-center gap-2 hover:opacity-90 transition-opacity cursor-pointer"
            >
      ...
      {showToast && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 40 }}
          className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-white dark:bg-[#1E293B] rounded-xl shadow-lg border border-gray-100 dark:border-white/[0.06] px-5 py-4"
        >
